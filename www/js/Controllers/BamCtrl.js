angular.module('starter')
        ...
        .controller('BamRespostaSelecionadaCtrl', function (StorageModuloFactory, Config, ExtraModuloFactory, $scope, LoadModuloFactory, ValidacaoModuloFactory, UsuariosApiFactory, $stateParams) {
