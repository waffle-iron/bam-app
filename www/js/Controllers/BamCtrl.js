angular.module('starter')
        ...
        .controller('BamRespostaSelecionadaCtrl', function (moment, ExtraModuloFactory, $scope, LoadModuloFactory, ValidacaoModuloFactory, UsuariosApiFactory, $stateParams) {
            ...
            LoadModuloFactory.show();
            UsuariosApiFactory.respostaSelecionada($stateParams.id, conteudo);
